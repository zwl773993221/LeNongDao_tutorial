...
│      u-boot-hi35xx.bin --------------------------------- u-boot image
│      rootfs_hi35xx_64k_.jffs2  ---------------------------------- jffs2 rootfs image(spi-flash blocksize = 64K)
│      rootfs_hi35xx_128k.jffs2 ---------------------------------- jffs2 rootfs image(spi-flash blocksize = 128K)
│      rootfs_hi35xx_256k.jffs2 ---------------------------------- jffs2 rootfs image(spi-flash blocksize = 256K)
│      rootfs_hi35xx_2k_4bit.yaffs2 ------------------------------ yaffs2 rootfs image(nand-flash pagesize=2K ecc=4bit)
│      rootfs_hi35xx_2k_128k_32M.img ----------------------ubifs rootfs image(nand-flash pagesize=2K blocksize = 128K)
│
├─image_uclibc -------------------------------------------- Images compiled with hisiv300
│      uImage_hi35xx --------------------------------------------- kernel image
│      u-boot-hi35xx.bin --------------------------------- u-boot image
│      rootfs_hi35xx_64k.jffs2  ---------------------------------- jffs2 rootfs image(spi-flash blocksize = 64K)
│      rootfs_hi35xx_128k.jffs2 ---------------------------------- jffs2 rootfs image(spi-flash blocksize = 128K)
│      rootfs_hi35xx_256k.jffs2 ---------------------------------- jffs2 rootfs image(spi-flash blocksize = 256K)
│      rootfs_hi35xx_2k_4bit.yaffs2 ------------------------------ yaffs2 rootfs image(nand-flash pagesize=2K ecc=4bit)
│      rootfs_hi35xx_2k_128k_32M.img ----------------------ubifs rootfs image(nand-flash pagesize=2K blocksize = 128K)
