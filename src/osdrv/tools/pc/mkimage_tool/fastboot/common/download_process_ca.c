/*
arm-hisiv200-linux-gcc generate .cfi_* segment

cp download_process.c uboot/common

cd uboot/common

arm-eabi-gcc   -D__ASSEMBLY__ -g  -Os   -fno-strict-aliasing -fno-common -ffixed-r8    -D__KERNEL__ -DTEXT_BASE=0x80500000 -I/home/jzl/work/workspace/out/target/godbox/sdk.new/uboot/u-boot-2010.06/include -fno-builtin -ffreestanding -nostdinc -isystem /home/jzl/android/toolchain/arm-eabi-4.4.0/bin/../lib/gcc/arm-eabi/4.4.0/include -pipe  -DCONFIG_ARM -D__ARM__ -marm  -mabi=aapcs-linux -mno-thumb-interwork -march=armv7-a -S download_process.c -o download_process.S
*/
