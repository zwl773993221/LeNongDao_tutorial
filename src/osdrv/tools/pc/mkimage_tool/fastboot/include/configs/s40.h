...
#define CONFIG_RESERVE_MEM_GAP         48*1024*1024
...
#  define CONFIG_CUR_UART_BASE          REG_BASE_UART0
#endif
#ifdef CHIP_TYPE_hi3716cv200
#  define CONFIG_PL011_CLOCK            83300000
#  define CONFIG_CONS_INDEX             0
#  define CONFIG_CUR_UART_BASE          REG_BASE_UART0
#endif
#ifdef CHIP_TYPE_hi3719mv100es
...
#define CONFIG_SHOW_MEMORY_LAYOUT
...
#  define CONFIG_BOOTROM_CA_SUPPORT
#else
